...
const useStyles = makeStyles((theme) => ({
  ...
  const url = 'https://crm.patrulhasolutions.com.br/clients/invoices/';
  const abrirNovaAba = () => {
  ...
  return (
    <MainContainer>
      ...
      <center><div>Teste de diagramação</div></center>
            ...
            <>
              {invoices.map((invoices) => (
                <TableRow style={rowStyle(invoices)} key={invoices.id}>
                  ...
                  <TableCell align="center">{invoices.companyName}</TableCell>
