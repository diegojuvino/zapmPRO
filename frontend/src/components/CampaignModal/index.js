...
import { MenuItem as MuiMenuItem, Checkbox, ListItemText } from "@material-ui/core";
...
const CampaignModal = ({
  ...
  useEffect(() => {
    if (isMounted.current) {
      ...
      api.get(`/campaigns/${campaignId}`).then(({ data }) => {
        console.log(data,"minha campanha")
        setCampaign(prev => {
  ...
  return (
    <div className={classes.root}>
      <ChatGPTModal
        title="Chat GPT - Gerador de mensagens"
        open={chatGptOpen}
                ...
                <Grid spacing={2} container>
                  ...
                  <Grid xs={12} md={4} item>
                    ...
                    <FormControl
                      ...
                      className={classes.formControl}
                    >
                      <InputLabel id="tags-selection-label">
                        {i18n.t("Tags")}
                      </InputLabel>
                      <Field
                        as={FormControl}
                      ...
                      >
                        ...
                        <Select
                          ...
                          renderValue={(selected) =>
                            selected
                              .map((tagId) =>
                                selectedTags.find((tag) => tag.id === tagId)?.name
                              )
                              .join(", ")
                          }
                          style={{ width: '150px' }}
